    ...
    <div>
      <header className="navbar">
        ...
        <nav className={`nav-links ${menuOpen ? "open" : ""}`}>
          ...
          <a href="https://autox.solutions">AutoX Solutions</a>
        </nav>
      </header>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <button className="button" onClick={handleRedirect}>
            Get Started with AutoX Solutions
          </button>
        </div>
      </section>
          ...
          <h2>Our Services</h2>
            <div className="container">
              ...
              <ul>
                ...
                <ol><strong>✅ Access AutoX Solutions—For Free:</strong> Clients who outsource testing to us get <strong>full access to AutoX Solutions</strong>, our in-house test automation platform, at <strong>no additional cost</strong>.</ol>
              ...
              <p>
                ...
                Let’s explore how we can help you scale quality engineering—and give you powerful platform like AutoX Solutions, for free.
              </p>
              <div className="cta-buttons">
                ...
                <button className="button" onClick={handleRedirect}>Get a Demo of AutoX Solutions</button>
              </div>
            </div>
        </section>
